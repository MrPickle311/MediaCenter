...
#include "TestingUtils/MediatorPackage.hpp"
...
TEST_F(BackendTEST, UnsupportedCommand) {
  ...
  auto wrapper{createQueryAboutCaller(*mocks_.data_storage_, pack,
...
TEST_F(BackendTEST, MixedCalls) {
  ...
  auto wrapper{createQueryAboutCaller(*mocks_.data_storage_,
                                      multimedia_engine_pack, calls_count)};
  wrapper->setPrecall(
